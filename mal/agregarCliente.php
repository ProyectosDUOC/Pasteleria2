<?php
    /*require_once("bd.php");
    $bd = new BD(); 
    $sql = "insert into cliente(idCliente ,rut ,nombres ,apellidos, fechaNacimiento, telefono, correo, comuna,activo)values(07854,'1-1','patricia','campos','98-05-03',555,'jakja',45,1)";
